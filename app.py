...
@st.cache_data
def load_data():
    return pd.read_csv("room_layout_coordinates.csv")  # Make sure this CSV exists with x0, y0, x1, y1
...
st.markdown("""
---
Built with ❤️ to compare residential projects room-by-room visually. Ensure your coordinate CSV includes columns: `Project`, `Floor`, `Room`, `x0`, `y0`, `x1`, `y1`.
""")
